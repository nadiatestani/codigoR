...
#cambio esto, porque di vuelta las latitudes:
...
latitudes_valores<-(datos_dimensiones$lat)
...
extremos_d<-as.matrix(rbind(maximos_por_mes_campo, maximos_por_mes_netcdf, minimos_por_mes_campo,minimos_por_mes_netcdf))
